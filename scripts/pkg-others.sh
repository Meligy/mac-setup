...
(
    ...
    home_url="https://bahoom.com/finderpath" && \
        ...
        curl -L -C - $full_download_url -o $zipped_filename && \
...
#     echo $audacity_url && \
#     curl -L -C - $audacity_url -o audacity-macos.dmg  #&& \
...
# (
#     cd $TEMP_Apps && \
#     curl -L -C - "https://go.microsoft.com/fwlink/?linkid=853070" -o CompanyPortal.pkg && \
